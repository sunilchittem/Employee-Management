...
<body>
	...
	<br>
	<form action="add-emp" method="get">
	...
	<table class="table table-success table-striped">
		...
		<c:forEach var="emp" items="${employees}">
			<tr>
				...
				<td><a
					href="/Employee-Management-System/delete-employee?empId=${emp.employeeId}"
					onclick="if(!(confirm('do you really want to delete the employee?'))) return false">Delete</a></td>
				<td><a href="/Employee-Management-System/update-employee?empId=${emp.employeeId}">Update</a></td>
